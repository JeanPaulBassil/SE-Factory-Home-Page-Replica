...
export default function Extras(params) {
    return(
        <div className="extras">
            ...
            <img alt="testimonial" src="https://images.squarespace-cdn.com/content/v1/5e4442200ffeee35974d1060/1590309858140-XJ7CNQPJOWQWP1GSERVR/RP%2Bpartner%2Blogos.jpg?format=2500w"/>
        </div>
    )
};
