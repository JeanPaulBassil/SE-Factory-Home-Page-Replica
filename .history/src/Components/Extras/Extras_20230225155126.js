...
export default function Extras(params) {
    return(
        <div className="extras">
            ...
            <img className="partners" alt="partners" src="https://images.squarespace-cdn.com/content/v1/5e4442200ffeee35974d1060/1590309858140-XJ7CNQPJOWQWP1GSERVR/RP%2Bpartner%2Blogos.jpg?format=2500w"/>
            <img className="testimonial" alt="testimonial" src="https://images.squarespace-cdn.com/content/v1/5e4442200ffeee35974d1060/1592602342483-2G3F5RI556MOC508C6UK/Artboard+86%403x-100.jpg?format=1500w"/>
        </div>
    )
};
